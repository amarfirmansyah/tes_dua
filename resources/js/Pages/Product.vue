...
import {List, Product} from "@/Interfaces/component";
...
const manufacturer = ref<List[]>([])
const categories = ref<List[]>([])
const statuses = ref<List[]>([])
const units = ref<List[]>([])
...
const getData = () => {
    ...
    ProductService.getAll()
        .then(response => {
            ...
            loading.value = false
        }).catch(err => console.log('data product: ' + err))

    ManufacturerService.getAll()
        .then(response => {
            manufacturer.value = response.data.data
    ...
    StatusService.getAll()
        ...
        }).catch(err => console.log('statuses: ' + err))

    UnitService.getAll()
        .then(response => {
            units.value = response.data.data
        }).catch(err => console.log('unit: ' + err))
}
